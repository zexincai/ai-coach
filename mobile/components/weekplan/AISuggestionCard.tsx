...
export function AISuggestionCard({ suggestion, onAdjust, onIgnore }: Props) {
  return (
    <View
      className="rounded-xl p-lg flex-col gap-md"
      style={{
        backgroundColor: "rgba(217,227,242,0.3)",
        borderWidth: 1,
        borderColor: "#d9e3f2",
      }}
    >
      <View className="flex-row items-start gap-md">
        <View
          className="w-12 h-12 rounded-full bg-surface-container-lowest items-center justify-center"
          style={{
        ...
        <View className="flex-1">
          <View className="flex-row items-center gap-xs mb-xs">
            ...
            <View className="px-xs py-0.5 rounded bg-primary">
              <Text className="text-[10px] text-white" style={{ fontWeight: "600", letterSpacing: 0.5 }}>Beta</Text>
            </View>
          </View>
      ...
      <View className="flex-row gap-sm">
        <TouchableOpacity
          onPress={onIgnore}
          className="flex-1 h-11 rounded-xl bg-surface-container-lowest items-center justify-center"
          style={{ borderWidth: 1, borderColor: "#c3c6d6" }}
        >
